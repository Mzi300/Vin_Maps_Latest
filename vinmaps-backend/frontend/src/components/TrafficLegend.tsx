...
export const TrafficLegend: React.FC = () => {
  ...
  return (
    <div style={{ position: 'absolute', bottom: 20, left: 20, background: 'rgba(255,255,255,0.9)', padding: '8px 12px', borderRadius: '6px', boxShadow: '0 2px 6px rgba(0,0,0,0.2)' }}>
      <h4 style={{ margin: 0, marginBottom: '4px', fontSize: '14px' }}>Traffic Legend</h4>
      {levels.map((l) => (
        <div key={l.level} style={{ display: 'flex', alignItems: 'center', marginBottom: '2px' }}>
